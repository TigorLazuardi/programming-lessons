...
function forLoopUntilNumber(num: number) {
...
console.log('==================================')
function printsOnlyOdd(num: number) {
...
console.log('==================================')
function breaksWhenOdd(num: number) {
...
function whileLoopUntilNumber(num: number) {
...
function doWhileUntilNumber(num: number) {
